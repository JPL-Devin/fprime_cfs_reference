...
/*
** F Prime application scheduler tick message.
**
** A cFS command message (stream ID 0x1890: command type + secondary header
** flag + APID 0x090) with function code 0. The fprime_app CfsBridge
** subscribes to this message ID and the CfsRouter routes APID 0x090 to the
** FPrimeCfs.SchAppDriver, which drives the F Prime rate groups.
*/
#define FPRIME_APP_SCH_TICK_MID 0x1890
...
/*{ { CFE_MAKE_BIG16(SC_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
  ...
  */
    /* command ID #16 - F Prime application scheduler tick */
  { { CFE_MAKE_BIG16(FPRIME_APP_SCH_TICK_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
