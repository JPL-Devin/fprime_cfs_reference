...
CFE_Status_t FPRIME_APP_TblValidationFunc(void *TblData)
{
    ...
    FPRIME_APP_ExampleTable_t *TblDataPtr = (FPRIME_APP_ExampleTable_t *)TblData;

    /*
    ** Sample Example Table Validation
    */
    if (TblDataPtr->Int1 > FPRIME_APP_PLATFORM_TBL_ELEMENT_1_MAX)
    {
        /* First element is out of range, return an appropriate error code */
        ReturnCode = FPRIME_APP_PLATFORM_TABLE_OUT_OF_RANGE_ERR_CODE;
    }
