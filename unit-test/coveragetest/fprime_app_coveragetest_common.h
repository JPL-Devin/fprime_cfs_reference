 ...
 * @file
 *
 * Common definitions for all fprime_app coverage tests
 */

#ifndef FPRIME_APP_COVERAGETEST_COMMON_H
#define FPRIME_APP_COVERAGETEST_COMMON_H
...
#endif /* FPRIME_APP_COVERAGETEST_COMMON_H */
